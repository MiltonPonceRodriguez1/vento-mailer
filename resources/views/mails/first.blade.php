...
<div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;"> ¡Explora la ciudad sin límites! </div>
    ...
    <div id="title">
        ...
        <p>Estrena hoy tu Vento {{$motorcycle}} con {{$discount}} de descuento en <a href="{{$header_url}}"><b>www.vento.com</b></a></p>

        <!--<div class="btn" style="margin-top:30px;">
            <p><a href="{{$header_url}}">QUIERO MÁS INFORMACIÓN</a></p>
        </div>
    ...
    <div id="detalles">
		...
		<a href="{{$plans_url}}">
			<center>
                <img src="{{$motorcycle_img_360}}" style="margin-top:20px;">
            </center>
		</a>
				...
				<td>
					<table>
						<tr>
							...
							<td>
								<p align="left" style="font-size:25px;line-height:25px;"><b>{{$displacement}}</b></p>
				...
				<td>
					<table>
						<tr>
							...
							<td>
								<p align="left" style="font-size:25px;line-height:25px;"><b>{{$max_speed}}</b></p>
				...
				<td>
					<table>
						<tr>
							...
							<td>
								<p align="left" style="font-size:25px;line-height:25px;"><b>{{$performance}}</b></p>
				...
				<td>
					<table>
						<tr>
							...
							<td>
								<p align="left" style="font-size:25px;line-height:25px;"><b>{{$speeds}}</b></p>
				...
				<td>
					<table>
						<tr>
							...
							<td>
								<p align="left" style="font-size:25px;line-height:25px;"><b>{{$power}}</b></p>
    ...
    <div id="detallesm">
		<p style="text-align:center;font-size:25px;"><b>360°</b></p>
		<a href="{{$plans_url}}">
			<center><img src="{{$motorcycle_img_360}}"></center>
		</a>
    ...
    <div id="vermas" style="background-color:#000000;">
        <div id="contenedorvermas">
            ...
            <div class="opcionver">
                <a href="{{$option_one_url}}">
                    <center><img src="{{$option_one_img}}" width="90%"></center>
                </a>
            </div>
            <div class="opcionver">
                <a href="{{$option_two_url}}">
                    <center><img src="{{$option_two_img}}" width="90%"></center>
                </a>
            </div>
            <div class="opcionver">
                <a href="{{$option_three_url}}">
                    <center><img src="{{$option_three_img}}" width="90%"></center>
                </a>
            </div>
        </div>
    </div>
